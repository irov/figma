...
- Low-level numeric structs such as `Vec2f`, `Rectf`, and `Colorf` stay aggregate structs without user-defined constructors; callers use brace initialization like `Colorf{1.0f, 1.0f, 1.0f, 1.0f}`.
