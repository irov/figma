...
protected:
    ...
    static CGFloat verticalScaleForLine(FT_Face _face, const Figma::RenderCommand & _command, const Figma::RenderTextLineDesc & _line, CGFloat _rasterScale);
    ...
    static std::string_view sourceTextView(const Figma::RenderCommand & _command, const Figma::RenderTextLineDesc & _line);
    static std::string_view textLineView(const Figma::RenderCommand & _command, std::size_t _lineIndex);
    ...
    static void blendGlyphBitmapPixel(const FT_Bitmap & _bitmap, NSInteger _sourceX, NSInteger _sourceY, unsigned char * const _target, const Figma::RenderCommand & _command);
    static NSImage * makeGlyphImage(const FT_Bitmap & _bitmap, const Figma::RenderCommand & _command);
    FT_Face faceForCommand(const Figma::RenderCommand & _command);
    std::string fontKeyForCommand(const Figma::RenderCommand & _command) const;
    ...
    void drawLine(FT_Face _face, const Figma::RenderCommand & _command, const std::vector<char32_t> & _codepoints, CGFloat _baselineX, CGFloat _baselineY, CGFloat _rasterScale, CGFloat _horizontalScale, CGFloat _verticalScale);
    void rasterizeDecodedLines(FT_Face _face, const Figma::RenderCommand & _command, CGFloat _rasterScale, unsigned char * const _pixels, NSUInteger _width, NSUInteger _height, NSUInteger _stride);
    void rasterizeLine(FT_Face _face, const Figma::RenderCommand & _command, const std::vector<char32_t> & _codepoints, CGFloat _baselineX, CGFloat _baselineY, CGFloat _horizontalScale, CGFloat _verticalScale, unsigned char * const _pixels, NSUInteger _width, NSUInteger _height, NSUInteger _stride);
